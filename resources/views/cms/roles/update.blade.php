...
@section('page_name',__('cms.update_role'))
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @if($errors->any()) is-invalid @endif " id="name"
                                    name="name" placeholder="{{__('cms.name')}}" value="{{$role->name}}">
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control usertype" style="width: 100%;" id="guard_name">
                                    ...
                                    {{-- <option value="pharmacist" @if($role->guard_name=='pharmacist') selected
                                        @endif>{{__('cms.Pharmacist')}}</option> --}}
