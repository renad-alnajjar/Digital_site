...
<head>
  ...
  <!-- theme meta -->
  <meta name="theme-name" content="bitbank" />
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" type="image/x-icon" href="{{asset('cms/img/favicon.png')}}" />

  <!-- CSS
  ================================================== -->
  <!-- Themefisher Icon font -->
  <link rel="stylesheet" href="{{asset('cms/plugins/themefisher-font.v-2/style.css')}}">
  <!-- bootstrap.min css -->
  <link rel="stylesheet" href="{{asset('cms/plugins/bootstrap/dist/css/bootstrap.min.css')}}">
  <!-- Slick Carousel -->
  <link rel="stylesheet" href="{{asset('cms/plugins/slick-carousel/slick/slick.css')}}">
  <link rel="stylesheet" href="{{asset('cms/plugins/slick-carousel/slick/slick-theme.css')}}">
  <!-- Main Stylesheet -->
		...
		<div class="row">
			<div class="col-lg-6 align-self-center mb-4 mb-lg-0">
				<div class="video-player">
					<img class="img-fluid rounded" src="{{asset('cms/images/slider/slider-bg-2.jpg')}}" alt="">
					<a class="play-icon">
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-6 col-xs-12" >
				<div class="service-block color-bg text-center">
					<div class="service-icon text-center">
						<img src="{{asset('cms/images/icons/bitcoin-safety-shield.png')}}" alt="">
					</div>
					<h3>Easy & Secure</h3>
			...
			<div class="col-md-4 col-sm-6 col-xs-12" >
				<div class="service-block text-center">
					<div class="service-icon text-center">
						<img src="{{asset('cms/images/icons/bitcoin-exchange.png')}}" alt="">
					</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-12 mx-auto"  >
				<div class="service-block color-bg text-center">
					<div class="service-icon text-center">
						<img src="{{asset('cms/images/icons/bitcoin-network.png')}}" alt="">
					</div>
						...
						<div class="item">
                            <div class="block">
                                ...
                                <div class="media client-meta">
                                  <img class="mr-3 client-thumb" src="{{asset('cms/images/client-logo/clients-1.jpg')}}" alt="Generic placeholder image">
		...
		<div class="row">
			...
			<article class="col-12 col-md-6" >
				<div class="post-item">
					<div class="post-thumb">
					  	<img class="img-fluid shadow rounded" src="{{asset('cms/images/blog/post-1.jpg')}}" alt="Generic placeholder image">
					</div>
			...
			<!-- single blog post -->
				<article class="col-12 col-md-6" >
					<div class="post-item">
						<div class="post-thumb">
						  	<img class="img-fluid shadow rounded" src="{{asset('cms/images/blog/post-2.jpg')}}" alt="Generic placeholder image">
						</div>
				  		<div class="post-title">
...
<footer id="footer" class="bg-one">
  ...
  <div class="footer-bottom">
    ...
    <!-- Main jQuery -->
    <script src="{{asset('cms/plugins/jquery/dist/jquery.min.js')}}"></script>
    <!-- Bootstrap -->
    <script src="{{asset('cms/plugins/bootstrap/dist/js/popper.min.js')}}"></script>
    <script src="{{asset('cms/plugins/bootstrap/dist/js/bootstrap.min.js')}}"></script>
    <!-- Owl Carousel -->
    <script src="{{asset('cms/plugins/slick-carousel/slick/slick.min.js')}}"></script>
    <script src="https://cdn.plot.ly/plotly-latest.min.js"></script>
    <!-- Smooth Scroll js -->
    <script src="{{asset('cms/plugins/smooth-scroll/dist/js/smooth-scroll.min.js')}}"></script>
